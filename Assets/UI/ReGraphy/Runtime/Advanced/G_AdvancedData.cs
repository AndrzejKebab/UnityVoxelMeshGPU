...
namespace Tayx.Graphy.Advanced
{
    public class G_AdvancedData : MonoBehaviour, IMovable, IModifiableState
    {
        ...
        [SerializeField] private TextMeshProUGUI m_graphicsDeviceVersionText = null;

        [SerializeField] private TextMeshProUGUI m_processorTypeText = null;

        [SerializeField] private TextMeshProUGUI m_operatingSystemText = null;

        [SerializeField] private TextMeshProUGUI m_systemMemoryText = null;

        [SerializeField] private TextMeshProUGUI m_graphicsDeviceNameText = null;
        [SerializeField] private TextMeshProUGUI m_graphicsMemorySizeText = null;
        [SerializeField] private TextMeshProUGUI m_screenResolutionText = null;
        [SerializeField] private TextMeshProUGUI m_gameWindowResolutionText = null;
        [SerializeField] private TextMeshProUGUI m_gameVRResolutionText = null;
